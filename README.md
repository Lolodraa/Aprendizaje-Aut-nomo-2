...
Aprendimos a como descargar he instalar PYTHON para poder comenzar con las actividades. A su vez, aprendimos sobre los tipos de errores en programación, y la manera como identificarlos.

SEMANA 3:
Aprendimos sobre las variables y como elaborar diagramas. Los principales y que se usaran para el primer aprendizaje autónomo son: Diagrama caso de uso y Diagrama de arquitectura de software.

SEMANA 4:
En esta semana aprendimos sobre los algoritmos y su importancia al momento de resolver errores y los diagramas de flujo, útiles para poder desarrollas el código que se presentara.

SEMANA 5:
En la semana 5, se aprendió sobre la estructura de decisión, los operadores racionales, operadores lógicos y la condicional “IF”. Estas condicionales.

SEMANA 6: 
Como aprendizaje autónomo 2 tuvimos que elaborar un diagrama de flujo y entregar el 50% del código funcional. Junto con eso grabar un video explicando cómo funciona de manera breve el código.

SEMANA 7:
Se implemento el uso de listas y ejecución de funciones. Esta es la última semana en la materia y se debe de entregar el Contacto con el docente.

Impacto tecnológico en la sociedad
Gracias a los avances tecnológicos que ha tenido la humanidad, se pudieron desarrollar varias herramientas para poder realizar o facilitar varios trabajos. En el caso de mi proyecto, un generador de contraseñas seguras, permite crear de manera aleatoria una contraseña de varios caracteres. Con ella podemos sentirnos más seguros al momento de crear una cuenta para el trabajo o personal. Utilizamos lo aprendido en la materia de Lógica de programación para que nuestro código sea efectivo y confíale.
